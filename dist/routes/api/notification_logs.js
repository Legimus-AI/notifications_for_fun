...
const notificationLogs_controller_1 = __importDefault(require("../../controllers/notificationLogs.controller"));
const authMiddlewares = [];
class ResourceRouter extends BaseRouter_1.default {
    constructor() {
        super(notificationLogs_controller_1.default, authMiddlewares);
        // Add custom route
